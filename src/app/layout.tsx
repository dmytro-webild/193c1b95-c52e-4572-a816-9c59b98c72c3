...
export const metadata: Metadata = {
  title: "All That Sparkle By Nikki | Elegant Event Planning",  description: "Premier event planning services for weddings, corporate events, and elegant celebrations. Expert coordination with sophisticated design and unforgettable experiences.",  keywords: "event planner, wedding planning, corporate events, celebration planning, event coordination, elegant events",  metadataBase: new URL("https://allthatsparklebynikki.com"),
  alternates: {
    canonical: "https://allthatsparklebynikki.com"},
  openGraph: {
    title: "All That Sparkle By Nikki | Elegant Event Planning",    description: "Create unforgettable celebrations with expert event planning, sophisticated design, and impeccable execution.",    url: "https://allthatsparklebynikki.com",    siteName: "All That Sparkle By Nikki, LLC",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-vector/golden-elegant-wedding-landing-page-template_23-2148220166.jpg",        alt: "Elegant gala event"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "All That Sparkle By Nikki | Event Planning",    description: "Premium event planning services for elegant celebrations",    images: ["http://img.b2bpic.net/free-vector/golden-elegant-wedding-landing-page-template_23-2148220166.jpg"],
  },
  robots: {
    index: true,
    follow: true,
